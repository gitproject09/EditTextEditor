package com.sopan.texteditor.helper;
...
public class EditTextEditor extends WebView {
  ...
  public EditTextEditor(Context context, AttributeSet attrs) {
    this(context, attrs, android.R.attr.webViewStyle);
  }

  @SuppressLint("SetJavaScriptEnabled")
  public EditTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
